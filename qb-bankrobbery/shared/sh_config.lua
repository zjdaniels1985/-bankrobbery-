...
Config.Gabz = { -- Set to true if using Gabz's Fleeca MLO's, automatically supports lower vault
    fleeca = true
}
...
Config.GreenLaptop = vector4(2892.58, 4371.02, 50.31, 270.88)
Config.BlueLaptop = vector4(-90.95, -2577.8, 6.0, 102.77)
Config.RedLaptop = vector4(2574.85, 1283.87, 44.54, 302.55)
Config.GoldLaptop = vector4(319.6, 2883.25, 46.38, 309.14)
Config.GreyUsb = vector4(-443.65, 288.33, 83.23, 43.01)
